BASE_PACKAGES = [
    "alsa-plugins", "alsa-tools", "alsa-utils", "bat", "bitwarden-cli", "bluez",
    "bluez-utils", "breeze", "brightnessctl", "btop", "calc", "celluloid", "exa",
    "fakeroot", "feh", "ffmpeg", "fish", "firefox", "git", "gnome-keyring", "gparted",
    "gzip", "htop", "hypridle", "hyprlock", "hyprpaper", "hyprpicker", "imagemagick",
...
AUR_DEV_PACKAGES = [
    "cava", "cloudflare-warp-bin", "dysk", "goofcord", "ptpython", "qview", "youtube-dl", "bitwarden-rofi-git"
]
